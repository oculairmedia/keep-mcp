...
- **Project Code**: `GKMCP`
- **Project Name**: Google Keep MCP
- **Letta Agent ID**: `agent-a67871be-220f-4c19-88c9-7a6db15f3583`

## Workflow Instructions

1. **Before starting work**: Search Huly for related issues using `huly-mcp` with project code `GKMCP`
2. **Issue references**: All issues for this project use the format `GKMCP-XXX` (e.g., `GKMCP-123`)
...
**Project PM Agent:** `Huly - Google Keep MCP` (agent-a67871be-220f-4c19-88c9-7a6db15f3583)
...
```json
{
  ...
  "agent": "Huly - Google Keep MCP",
  "message": "<your report>",
  "caller_directory": "/opt/stacks/Google Keep MCP"
}
```
...
**Project**: Google Keep MCP (`GKMCP`)
**Path**: `/opt/stacks/Google Keep MCP`
